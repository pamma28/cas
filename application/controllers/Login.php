...
class Login extends CI_Controller {
	...
	public function index()
	{
		if(!$this->session->userdata('logged'))
		{
			if ($this->input->get('do')=='login') {
				$this->session->set_flashdata('v','Anda telah keluar dari sistem');
			 	redirect('Login/auth');
			} else {
				$this->auth();
			}
    ...
    {  
		...
		($this->input->get('rdr')!='') ? $this->session->set_flashdata('rdr','Sesi Login Anda Telah Habis. Silahkan Login Ulang.'):null;
