  ...
  <?php if ($this->session->flashdata('rdr')!=null){ ?>
	...
	<div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url(); ?>"><b>Candra</b> Apple Solution</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Masukkan Kredensial Anda</p>
	 <?php
    ...
    <?php echo form_open('Login/auth',array('name'=>'login', 'method'=>'POST'));?>
          ...
          <div class="row">
            <div class="col-xs-8">    
                  ...
                  <input type="checkbox" name="remember" class="checkbox icheck">  Ingat saya
        ...
        <a href="<?=base_url('Login/reset');?>">Reset Sandi</a><br>
